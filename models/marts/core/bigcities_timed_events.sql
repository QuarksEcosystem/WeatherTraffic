...
big_cities_hours_traffic as(
    select big_cities_days.city, street,  to_timestamp(concat(days,' ', hours), 'dd/mm/yyyy hh24:mi:ss') as event_timestamp, type as traffic_events from big_cities_days
...
big_cities_hours_events as(
    select big_cities_hours_traffic.city, street, event_timestamp, traffic_events, type as weather_event from big_cities_hours_traffic
